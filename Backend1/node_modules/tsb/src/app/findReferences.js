    ...
    function FindReferences(props) {
        ...
        this.onChangeSelected = function (event) {
            ...
            if (keyStates.enter) {
                ...
                var def = _this.props.data.references[_this.state.selectedIndex];
...
CodeMirror.commands[commands.additionalEditorCommands.findReferences] = function (editor) {
    ...
    socketClient_1.server.getReferences({ filePath: filePath, position: position }).then(function (res) {
        if (res.references.length == 0) {
            ...
            ReactDOM.render(React.createElement(FindReferences, {data: res}), node);
        }
    });
};
