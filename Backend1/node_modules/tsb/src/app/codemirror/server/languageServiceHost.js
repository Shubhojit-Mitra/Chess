...
var copyListRemovingItem = ts.copyListRemovingItem;
...
var LSHost = (function () {
    ...
    LSHost.prototype.setContents = function (filename, contents) {
        var script = this.getScriptInfo(filename);
        if (script) {
    ...
    LSHost.prototype.getPositionOfLineAndCharacter = function (filePath, line, ch) {
        return this.lineOffsetToPosition(filePath, line + 1, ch + 1);
    };
    LSHost.prototype.getLineAndCharacterOfPosition = function (filePath, pos) {
